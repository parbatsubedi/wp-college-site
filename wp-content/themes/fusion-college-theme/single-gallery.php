        ...
        <section class="single-section">
            <div class="container">
                <div class="single-header">
                    <h1><?php the_title(); ?></h1>
                    <p class="single-meta">Gallery published on <?php echo get_the_date('F j, Y'); ?></p>
                </div>
                ...
                <div class="single-navigation">
                    <div class="nav-prev"><?php previous_post_link('%link', '← Previous Gallery'); ?></div>
                    <div class="nav-next"><?php next_post_link('%link', 'Next Gallery →'); ?></div>
                </div>
            </div>
        </section>
    <?php endwhile; ?>
...
.single-header h1 { color: #077E86; font-size: 3rem; margin-bottom: 10px; }
.single-meta { color: #777; }
.gallery-featured-image { margin-bottom: 30px; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 25px rgba(0,0,0,0.08); }
.gallery-featured-image img { width: 100%; display: block; }
